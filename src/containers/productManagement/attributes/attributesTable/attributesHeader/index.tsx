...
const AttributesHeader = () => {
    ...
    return (
        <div className={styles.attributesHeaders}>
            ...
            <div className={styles.tableHeader}>
                <div className={styles.nameWithArrow}>
                    <span className={"text-12_18 text-tertiary"}>Type</span>
                </div>
            </div>
            <div className={styles.tableHeader}>
                <div className={styles.nameWithArrow}>
                    <span className={"text-12_18 text-tertiary"}>Attached categories</span>
                </div>
            </div>
