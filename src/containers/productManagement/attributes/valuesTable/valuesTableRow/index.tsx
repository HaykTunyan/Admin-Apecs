...
interface ITableRow {
    ...
    name: string;
    color: string;
    onDelete: (x: IValue) => void;
    onEdit: (x: IValue) => void;
}

const ValuesTableRow = ({id, name, color, onDelete, onEdit}: ITableRow) => {
    ...
    return (
        <div
            ...
            className={styles.valuesHeaders}
        ...
        >
            ...
            <div className={styles.tableBlockNoPagination}>
                <span>{name}</span>
            </div>
