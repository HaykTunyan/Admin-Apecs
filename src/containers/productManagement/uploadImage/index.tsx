...
const UploadImage = ({width, height, setImage, initialImage}: IUploadForm) => {
        ...
        <div className={styles.rightUpload}>
            ...
            >
                ...
                <div className={styles.uploadTexts}>
                    ...
                    <span className={"text-12_18 text-tertiary"}>SVG, PNG, JPG or GIF (max. 800x400px)</span>
                </div>
            </div>
            {!selectedImage && !previewUrl &&
                <span className={"text-14_faux text-tertiary"}>The file size should not exceed 50 MB</span>
            }
            {selectedImage &&
                <div
