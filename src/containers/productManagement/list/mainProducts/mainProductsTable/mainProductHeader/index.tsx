...
const MainProductsHeader = () => {
    ...
    return (
        <div className={styles.mainProductsTableHeader}>
            ...
            <div className={styles.tableHeader}>
                <div className={styles.nameWithArrow}>
                    <span className={"text-12_18 text-tertiary"}>Category </span>
                </div>
            </div>
            <div className={styles.tableHeader}>
                <div className={styles.nameWithArrow}>
                    <span className={"text-12_18 text-tertiary"}>Subcategory</span>
                </div>
            </div>
...
export default MainProductsHeader;
